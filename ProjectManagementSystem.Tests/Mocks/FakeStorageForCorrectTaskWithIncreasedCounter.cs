...
{
    public class FakeStorageForCorrectTaskWithIncreasedCounter : IStorage
    {
        private readonly int _defaultViewCounter;

        public FakeStorageForCorrectTaskWithIncreasedCounter(int defaultViewCounter)
        {
            _defaultViewCounter = defaultViewCounter;
        }
        ...
        {
            var task = new TaskInfo(id, "A", "B", 10, 20, 10);
            task.ViewCounter = _defaultViewCounter;
            return task;
        }
